...
# load the image
image = cv2.imread("C:\Rajalingam\Training\Github\Multi_Label_Dress_Type_Classification-master\Multi_Label_Dress_Type_Classification-master\sva1.jpeg")
